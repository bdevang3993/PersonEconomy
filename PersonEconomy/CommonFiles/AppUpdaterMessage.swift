//
//  AppUpdaterMessage.swift
//  PersonEconomy
//
//  Created by devang bhavsar on 26/11/21.
//
...
class AppUpdaterMessage: NSObject {
    private static var _instance: AppUpdaterMessage?
    
    private override init() {
        
    }
    
    public static func getSingleton() -> AppUpdaterMessage {
        if (AppUpdaterMessage._instance == nil) {
            AppUpdaterMessage._instance = AppUpdaterMessage.init();
        }
        return AppUpdaterMessage._instance!;
    }
